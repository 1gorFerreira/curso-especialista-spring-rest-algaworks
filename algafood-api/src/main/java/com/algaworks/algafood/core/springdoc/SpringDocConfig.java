        ...
        return openApi -> {
            openApi.getPaths()
                    ...
                    .forEach(operation -> {
                        ...
                        ApiResponse apiResponseNaoEncontrado = new ApiResponse().description("Recurso nao encontrado");
                        ApiResponse apiResponseErroInterno = new ApiResponse().description("Erro interno no servidor");
                        ApiResponse apiResponseSemRepresentacao = new ApiResponse().description("Recurso nao possui uma representacao que poderia ser aceita pelo consumidor");
