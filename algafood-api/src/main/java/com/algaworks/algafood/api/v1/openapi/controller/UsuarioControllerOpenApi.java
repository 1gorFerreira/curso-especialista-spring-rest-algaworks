...
public interface UsuarioControllerOpenApi {
	...
	ResponseEntity<UsuarioModel> buscar(@Parameter(description = "ID do usuário", example = "1", required = true) Long usuarioId);

	@Operation(summary = "Cadastra um usuário",
			responses = {
				@ApiResponse(responseCode = "201", description = "Usuário cadastrado"),
	})
	ResponseEntity<UsuarioModel> adicionar(@RequestBody(description = "Representação de um novo usuário", required = true) UsuarioComSenhaInput usuarioInput);
	...
	ResponseEntity<UsuarioModel> atualizar(@Parameter(description = "ID do usuário", example = "1", required = true) Long usuarioId,
