...
public interface FormaPagamentoControllerOpenApi {
	...
	ResponseEntity<FormaPagamentoModel> adicionar(@RequestBody(description = "Representação de uma nova forma de pagamento", required = true) FormaPagamentoInput formaPagamentoInput);
	...
	ResponseEntity<FormaPagamentoModel> atualizar(@Parameter(description = "ID de uma forma de pagamento", example = "1", required = true) Long formaPagamentoId,
	...
	ResponseEntity<Void> deletar(@Parameter(description = "ID de uma forma de pagamento", example = "1", required = true) Long formaPagamentoId);
}