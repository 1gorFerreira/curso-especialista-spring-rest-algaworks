...
public interface EstadoControllerOpenApi {
	...
	ResponseEntity<EstadoModel> buscar(@Parameter(description = "ID de um estado", example = "1", required = true) Long estadoId);
	...
	ResponseEntity<EstadoModel> atualizar(@Parameter(description = "ID de um estado", example = "1", required = true) Long estadoId,
	...
	ResponseEntity<?> remover(@Parameter(description = "ID de um estado", example = "1", required = true) Long estadoId);
}
