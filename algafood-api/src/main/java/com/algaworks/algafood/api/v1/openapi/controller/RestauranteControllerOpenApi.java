...
//  @JsonView(RestauranteView.Resumo.class)
	...
	ResponseEntity<RestauranteModel> buscar(@Parameter(description = "ID de um restaurante", example = "1", required = true) Long restauranteId);

	@Operation(summary = "Cadastra um restaurante", responses = {
			@ApiResponse(responseCode = "201", description = "Restaurante cadastrado"),
	})
	ResponseEntity<RestauranteModel> adicionar(@RequestBody(description = "Representação de um novo restaurante", required = true) RestauranteInput restauranteInput);
	...
	ResponseEntity<RestauranteModel> atualizar(@Parameter(description = "ID de um restaurante", example = "1", required = true) Long restauranteId,
