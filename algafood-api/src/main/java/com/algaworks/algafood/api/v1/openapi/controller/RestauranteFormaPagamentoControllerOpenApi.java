...
public interface RestauranteFormaPagamentoControllerOpenApi {
	...
	ResponseEntity<Void> removerFormaPagamento(@Parameter(description = "ID do restaurante", example = "1", required = true) Long restauranteId,
	...
	ResponseEntity<Void> adicionarFormaPagamento(@Parameter(description = "ID do restaurante", example = "1", required = true) Long restauranteId,
												 @Parameter(description = "ID da forma de pagamento", example = "1", required = true) Long formaPagamentoId);
}