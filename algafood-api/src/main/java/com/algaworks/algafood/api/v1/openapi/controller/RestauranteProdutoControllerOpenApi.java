...
public interface RestauranteProdutoControllerOpenApi {
	...
	ResponseEntity<CollectionModel<ProdutoModel>> listarProdutos(@Parameter(description = "ID do restaurante", example = "1", required = true) Long restauranteId,
	...
	ResponseEntity<ProdutoModel> buscar(@Parameter(description = "ID do restaurante", example = "1", required = true) Long restauranteId,
	...
	ResponseEntity<ProdutoModel> adicionar(@Parameter(description = "ID do restaurante", example = "1", required = true) Long restauranteId,
	...
	ResponseEntity<ProdutoModel> atualizar(@Parameter(description = "ID do restaurante", example = "1", required = true) Long restauranteId,
										   @Parameter(description = "ID do produto", example = "1", required = true) Long produtoId,
