...
public interface GrupoControllerOpenApi {
	...
	ResponseEntity<GrupoModel> buscar(@Parameter(description = "ID de um grupo", example = "1", required = true) Long grupoId);

	@Operation(summary = "Cadastra um grupo",
			responses = {
				@ApiResponse(responseCode = "201", description = "Grupo cadastrado"),
	})
	ResponseEntity<GrupoModel> adicionar(@RequestBody(description = "Representação de um novo grupo", required = true) GrupoInput grupoInput);
	...
	ResponseEntity<GrupoModel> atualizar(@Parameter(description = "ID de um grupo", example = "1", required = true) Long grupoId,
	...
	ResponseEntity<Void> deletar(@Parameter(description = "ID de um grupo") Long grupoId);
